...
update() {
  this.user.id = this.editForm.controls['id'].value
  this.user.name = this.editForm.controls['name'].value
  this.user.surname = this.editForm.controls['surname'].value
  this.user.birthDate = this.editForm.controls['birthdate'].value
  this.user.phone = this.editForm.controls['phone'].value
  this.user.city = this.editForm.controls['city'].value
  this.user.street = this.editForm.controls['street'].value
  this.user.number = this.editForm.controls['number'].value
